...
function Check({children}) {
  return (
    <p className="flex items-center gap-3 mb-3 text-xl font-light text-gray-700 md:mb-5 md:text-2xl">
    ...
    <div className="container">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        <div className="flex flex-col items-end">
          <div className="flex md:max-w-[340px] w-full items-center gap-6 px-6 h-[115px] text-xl text-white bg-gradient-to-r from-indigo-400 to-indigo-500 rounded-xl mb-4">
            <SlLocationPin className="text-5xl text-white opacity-50 shrink-0"/>
            ადგილზე ვიზიტი
          </div>
          <div className="flex md:max-w-[340px] w-full items-center gap-6 px-6 h-[115px] text-xl text-white bg-gradient-to-r from-red-400 to-red-500 rounded-xl">
